...
def load_models():
    return {
        'densenet': load_model('D:\\Capstone_MiniProjects_Guvi\\emotional\\image\\densenet_model.keras'),
        'resnet': load_model('D:\\Capstone_MiniProjects_Guvi\\emotional\\image\\resnet_model.keras'),
        'vgg': load_model('D:\\Capstone_MiniProjects_Guvi\\emotional\\image\\vgg_model.keras'),
        'mobilenet': load_model('D:\\Capstone_MiniProjects_Guvi\\emotional\\image\\mobilenet_model.keras'),
        'efficientnet': load_model('D:\\Capstone_MiniProjects_Guvi\\emotional\\image\\efficientnet_model.keras'),
        'custom_cnn': load_model('D:\\Capstone_MiniProjects_Guvi\\emotional\\image\\custom_cnn_model.keras')
    }
