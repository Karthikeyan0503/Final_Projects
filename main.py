...
def main():
    ...
    if uploaded_file is not None:
        try:
            ...
            # Load model
            model_path = 'D:\Capstone_MiniProjects_Guvi\Final_Pros\Plant-Disease-Detection-from-Images-main\Plant-Disease-Detection-from-Images-main\cnn_model.pth'  # Ensure this path is correct relative to your Streamlit app
